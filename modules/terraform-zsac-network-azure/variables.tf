...
variable "base_only" {
  type        = bool
  description = "Default is false. Only applicable for base deployment type resulting in workload and bastion hosts, but no App Connector resources. Setting this to true will point workload route able to Internet"
  default     = false
}
