...
| <a name="input_user_codes"></a> [user\_codes](#input\_user\_codes) | Optional: List of OAuth2 user codes used to enroll App Connectors into this group. Populated automatically by the OAuth2 onboarding flow; leave empty when onboarding via provisioning key. | `list(string)` | `[]` | no |
